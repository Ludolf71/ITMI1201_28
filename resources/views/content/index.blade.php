...
@section('content')
    ...
    <div class="d-flex justify-content-end mb-3">
        <a href="{{ url('http://127.0.0.1:8000/login') }}" role="button" class="btn btn-sm btn-warning">logout</a>
    </div>
    <div class="mb-2">
        <a href="{{ url('content/create') }}" role="button" class="btn btn-sm btn-success">Create Content</a>
    </div>
    <div class="mb-2">
        <a href="{{ url('http://127.0.0.1:8000/') }}" role="button" class="btn btn-sm btn-info">Main menu</a>
    </div>
